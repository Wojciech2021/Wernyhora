...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'App\\Form\\AdminForms\\AddDepartmentType' => ['privates', 'App\\Form\\AdminForms\\AddDepartmentType', 'getAddDepartmentTypeService', true],
            'App\\Form\\AdminForms\\AssignRolesType' => ['privates', 'App\\Form\\AdminForms\\AssignRolesType', 'getAssignRolesTypeService', true],
            'App\\Form\\DisplayComputerLogForms\\DisplayComputerLogForm' => ['privates', 'App\\Form\\DisplayComputerLogForms\\DisplayComputerLogForm', 'getDisplayComputerLogFormService', true],
            'App\\Form\\Project\\AddProjectType' => ['privates', 'App\\Form\\Project\\AddProjectType', 'getAddProjectTypeService', true],
            'App\\Form\\Project\\EditProjectType' => ['privates', 'App\\Form\\Project\\EditProjectType', 'getEditProjectTypeService', true],
            ...
            'App\\Form\\AdminForms\\AddDepartmentType' => '?',
            'App\\Form\\AdminForms\\AssignRolesType' => '?',
            'App\\Form\\DisplayComputerLogForms\\DisplayComputerLogForm' => '?',
            'App\\Form\\Project\\AddProjectType' => '?',
            'App\\Form\\Project\\EditProjectType' => '?',

 ...
 */
class getCriteryRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CriteryRepository' shared autowired service.
     *
     * @return \App\Repository\CriteryRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CriteryRepository.php';

        return $container->privates['App\\Repository\\CriteryRepository'] = new \App\Repository\CriteryRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}

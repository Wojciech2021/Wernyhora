        ...
        echo "
            ...
            <div class=\"pt-3 input-group\">
                <div class=\"pb-1 input-group-prepend\">
                    ";
        // line 22
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 22, $this->source); })()), "description", [], "any", false, false, false, 22), 'label', ["label_attr" => ["class" => "input-group-text"]]);
        // line 24
        echo "
                </div>
";
...
";
        ...
        echo "            </div>
            <div class=\"pt-3\">
                ";
        // line 33
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 33, $this->source); })()), "addProject", [], "any", false, false, false, 33), 'widget');
        echo "
            </div>
        </div>
    </div>
...
";
    ...
    {
        return array (  140 => 37,  133 => 33,  129 => 31,  126 => 29,  123 => 27,  119 => 24,  117 => 22,  109 => 17,  103 => 14,  95 => 9,  92 => 8,  89 => 7,  79 => 6,  59 => 4,  36 => 1,);
    }
